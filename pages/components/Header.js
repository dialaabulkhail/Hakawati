          ...
          <div class="flex justify-start items-center">
              ...
              <form action="#" method="GET" class="hidden lg:block lg:pl-2">
                ...
                <div class="relative mt-1 lg:w-96">
                  ...
                  <input type="text" name="email" id="topbar-search" class="bg-gray-5 border outline-0 text-gray-900 sm:text-sm rounded-lg  block w-full pl-10 p-2.5 dark:bg-gray-700  dark:placeholder-gray-400 dark:text-white " placeholder="Search"/>
                </div>
              </form>
            </div>
          <div class="flex items-center lg:order-2">
              <button type="button" class=" sm:inline-flex items-center justify-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 rounded-lg  px-3 py-1.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"> صفحتي</button>
